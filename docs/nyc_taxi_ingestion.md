...
- **High Volume FHV (HVFHV)** — Uber, Lyft and Via trips specifically; the largest dataset, available from 2019
...
raw/hvfhv_rides/partition_date=2024-01-01/fhvhv_tripdata_2024-01.parquet
```
