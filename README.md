...
- `taxi_final` — reads from staging tables, builds 4 unified/enriched tables (`trips`, `revenue`, `weather_impact`, `zones_geo`), and registers them in the `final` database. Triggers automatically when all 4 staging taxi assets are updated.
