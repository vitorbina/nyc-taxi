...
def transform_fhv(input_path: str, zones_path: str, output_dir: str) -> str:
    ...
    logger.info(f"FHV curated saved to: {final_path}")
    return final_path


def curate_fhv(lake_folder: str, year: str, month: str, bucket: str):
    ...
    try:
        ...
        output_path = transform_fhv(input_path, zones_path, output_dir)
