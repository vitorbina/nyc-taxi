...
def transform_green(input_path: str, output_dir: str) -> str:
    ...
    df = df.select(
        ...
        F.col("trip_type").cast(IntegerType()),
    ...
    logger.info(f"Green staging saved to: {final_path}")
    return final_path
...
def stage_green(lake_folder: str, year: str, month: str, bucket: str):
    ...
    try:
        ...
        output_path = transform_green(input_path, output_dir)
